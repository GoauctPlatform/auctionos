...
print("--- EXECUTING ITEMS QUERY WITH PARAMS ON REMOTE DB ---")
try:
    ...
    with engine.connect() as conn:
        ...
        print(f"Items query executed successfully! Returned {len(result)} items.")
        if result:
            print("First item address:", result[0][16])
